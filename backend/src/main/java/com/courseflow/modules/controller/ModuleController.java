...
public class ModuleController {
    ...
    @RequireInstructor
    @Operation(summary = "Update modules", description = "Replace entire module tree for a course. Only instructors and TAs can update modules.")
    ...
    @RequireInstructor
    @Operation(summary = "Add module", description = "Add a new module to a course. Only instructors and TAs can add modules.")
    ...
    @RequireInstructor
    @Operation(summary = "Add module item", description = "Add a new item to a module. Only instructors and TAs can add module items.")
