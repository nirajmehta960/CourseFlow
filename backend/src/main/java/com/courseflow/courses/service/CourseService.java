...
public class CourseService {
        ...
        public CourseResponse createCourse(CourseRequest request) {
                ...
                Course course = Course.builder()
                                ...
                                .published(courseStatus == Course.CourseStatus.PUBLISHED) // Keep for backward
                                                                                          // compatibility
        ...
        public CourseResponse updateCourse(String courseId, CourseRequest request) {
                ...
                if (request.getStatus() != null) {
                        ...
                        course.setPublished(course.getStatus() == Course.CourseStatus.PUBLISHED); // Keep for backward
                                                                                                  // compatibility
                } else if (request.getPublished() != null) {
                        course.setPublished(request.getPublished());
                        course.setStatus(request.getPublished() ? Course.CourseStatus.PUBLISHED
        ...
        public Enrollment enrollByEmail(String courseId, String email, Enrollment.CourseRole role) {
                ...
                User user = userRepository.findByEmail(email)
                                .orElseThrow(() -> new ApiException("USER_NOT_FOUND",
                                                "User with email " + email + " not found. User must sign up first.",
                                                404));
        ...
        public Enrollment updateEnrollment(String courseId, String enrollmentId,
                ...
                Enrollment enrollment = enrollmentService.getCourseEnrollments(courseId).stream()
                                ...
                                .findFirst()
                                .orElseThrow(() -> new ApiException("ENROLLMENT_NOT_FOUND", "Enrollment not found",
                                                404));
