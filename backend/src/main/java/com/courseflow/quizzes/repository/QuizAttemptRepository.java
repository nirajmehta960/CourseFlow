...
public interface QuizAttemptRepository extends MongoRepository<QuizAttempt, String> {
    ...
    /**
     * Find all attempts by a student for a quiz, ordered by submission time (newest
     * first).
     * 
     * @param quizId    The quiz ID
    ...
    /**
     * Find the most recent attempt (submitted or in-progress) for a student on a
     * quiz.
     * 
     * @param quizId    The quiz ID
     * @param studentId The student ID
     ...
     * @return Optional quiz attempt
     */
    Optional<QuizAttempt> findByQuizIdAndStudentIdAndStatus(String quizId, String studentId,
            QuizAttempt.AttemptStatus status);

    /**
     * Find all attempts for a list of quiz IDs.
     * 
